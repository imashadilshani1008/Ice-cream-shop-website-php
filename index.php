...
<body img scr="back.jpeg">
    ...
    <div class="main-content">
        <p>Enjoy the sweetness of world with us!</p>
        <img src="https://img.freepik.com/premium-photo/delicious-purple-ice-cream_978921-3503.jpg" width="400" height="300">
        <img src="https://img.freepik.com/premium-photo/top-view-strawberry-ice-cream-bowl-white-stone-background_908985-44098.jpg" width="500" height="300">
        <img src="https://img.freepik.com/premium-photo/delicious-purple-ice-cream-served-black-bowl-with-orchid-flowers-background_777078-118545.jpg" width="400" height="300">
    </div>
    <div class="main-content">
    <a href="orders.php"><button class="submit-btn" type="submit" name="submit" align="center">Place an order</button></a>
    </div>
</body>
</html>
